...
export function Testimonials() {
  ...
  // --- THE KITCHEN: Visuals & Metadata ---
  // Order corresponds exactly to the Dictionary list (João, Maria, Pedro, Ana, Carlos, Lucas)
  const testimonialVisuals = [
    ...
    },
    {
      ...
      rating: 5,
      verified: true,
      highlight: true, // The "Pro Player" highlight
    },
    {
